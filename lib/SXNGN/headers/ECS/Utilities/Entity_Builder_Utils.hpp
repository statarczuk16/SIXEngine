...
namespace SXNGN {
	namespace ECS {
		...
		{
		public:
			static Entity Create_Tile(Core::Coordinator coordinator, Sint32 x_grid, Sint32 y_grid, std::string sprite_sheet, std::string sprite_name, Components::CollisionType collision_type, std::string name = "unnamed_tile");

			static Entity Create_Person(Core::Coordinator coordinator, Sint32 x_grid, Sint32 y_grid, std::string sprite_sheet, std::string sprite_name, bool player_controlled = false, std::string name = "unnamed_person");
