...
namespace SXNGN {
	...
	const double OVERWORLD_PIXELS_TO_METERS = PIXELS_TO_METERS / OVERWORLD_MULTIPLIER; 
	const double OVERWORLD_METERS_TO_PIXEL = OVERWORLD_MULTIPLIER / PIXELS_TO_METERS;
