...
namespace SXNGN {
	...
	const double METERS_TO_PIXELS_2 = 1.0 / PIXELS_TO_METERS;
	const size_t OVERWORLD_MULTIPLIER = 64; //for time and distance (1 second = 60 seconds in game, 1 m = 60 m in game)

	const double OVERWORLD_PIXELS_TO_METERS = double(PIXELS_TO_METERS) / OVERWORLD_MULTIPLIER; //0.25
	const double OVERWORLD_METERS_TO_PIXEL = double(OVERWORLD_MULTIPLIER) / double(PIXELS_TO_METERS); //4
	const double OVERWORLD_PIXELS_TO_KM = OVERWORLD_PIXELS_TO_METERS * 1000.0; //250
	const double OVERWORLD_METERS_PER_GRID = 1024.0;
	const double OVERWORLD_GRIDS_PER_METER = 1.0 / OVERWORLD_METERS_PER_GRID;
	const double OVERWORLD_PIXELS_PER_GRID = OVERWORLD_PIXELS_TO_METERS * OVERWORLD_METERS_PER_GRID;//256
