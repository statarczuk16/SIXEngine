...
namespace SXNGN {
	namespace ECS {
		...
		Entity Entity_Builder_Utils::Create_Tile(A::Coordinator coordinator, Sint32 x_grid, Sint32 y_grid, std::string sprite_sheet, std::string sprite_name, A::CollisionType collision_type, std::string name )
		{
		...
		Entity Entity_Builder_Utils::Create_Person(A::Coordinator coordinator, Sint32 x_grid, Sint32 y_grid, std::string sprite_sheet, std::string sprite_name, bool player_controlled, std::string name)
		{
